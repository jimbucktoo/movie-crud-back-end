exports.seed = async function(knex) {
    ...
    await knex('movies').insert([
        ...
        { title: 'McQueen', directors: 'Ian Bonhôte', year: 2018, rating: 3, poster_url: 'https://m.media-amazon.com/images/M/MV5BODdlZjY1MWUtNDAwMy00Y2E4LWFhMzQtMjIxZGM4ZTIyNWMzXkEyXkFqcGdeQXVyNDY2MjcyOTQ@._V1_.jpg', user_id: userIds[1] },
